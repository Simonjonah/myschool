          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              {{-- <div class="form-group">
                ...
                <form action="{{ url('web/createclassactivity') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="subject" value="{{ $view_singlactivity->subject }}" placeholder="Subject">
                </div>

                <div class="form-group">
                    <input type="text" class="form-control" name="topic" value="{{ $view_singlactivity->topic }}" placeholder="Topic">
                  </div>

                  <div class="form-group">
                    <input type="url" class="form-control" name="youtube" value="{{ $view_singlactivity->youtube }}" placeholder="You Tube Link">
                  </div>
                <div class="form-group">
                    <textarea id="compose-textarea" name="messages" class="form-control" style="height: 300px">
                     
                     {!! $view_singlactivity->messages !!}
