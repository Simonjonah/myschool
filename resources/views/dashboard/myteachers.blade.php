                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach ($mmy_teachers as $mmy_teacher)
                      {{-- @if ($mmy_teacher->section == Auth::guard('web')->user()->section &&  $mmy_teacher->term == Auth::guard('web')->user()->term && $mmy_teacher->classname == Auth::guard('web')->user()->classname && $mmy_teacher->role == Auth::guard('web')->user()->role = null) --}}
                        <tr>
