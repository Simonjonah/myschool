            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <form action="{{ url('admin/updatelga/'.$editlga->id) }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      @enderror value="{{ $editlga->lga }}" id="exampleInputEmail1" placeholder="LGA Name">
                    </div>
                    @error('lga')
