          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              {{-- <div class="form-group">
                ...
                {{-- <form action="{{ url('admin/createclassactivityad') }}" method="post" enctype="multipart/form-data"> --}}
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="subject" value="{{ $view_singclassactivitis->subject }}" placeholder="Subject">
                </div>

                <div class="form-group">
                    <input type="text" class="form-control" name="topic" value="{{ $view_singclassactivitis->topic }}" placeholder="Topic">
                  </div>

                  <div class="form-group">
                    <input type="url" class="form-control" name="youtube" value="{{ $view_singclassactivitis->youtube }}" placeholder="You Tube Link">
                  </div>
                <div class="form-group">
                    <textarea id="compose-textarea" name="messages" class="form-control" style="height: 300px">
                     
                        {{ $view_singclassactivitis->messages }}
