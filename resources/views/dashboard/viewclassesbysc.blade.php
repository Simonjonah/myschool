                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach ($view_classnametudents as $view_classnametudent)
                      {{-- @if ($view_classnametudent->section == Auth::guard('web')->user()->section &&  $view_classnametudent->term == Auth::guard('web')->user()->term && $view_classnametudent->classname == Auth::guard('web')->user()->classname && $view_classnametudent->role == Auth::guard('web')->user()->role = null) --}}
                        <tr>
                          <td>{{ $view_classnametudent->fname }}</td>
                          <td>{{ $view_classnametudent->middlename }}</td>
                          <td>{{ $view_classnametudent->surname }}</td>
                          <td> {{ $view_classnametudent->section }}</td>
                          <td> {{ $view_classnametudent->classname }}</td>
