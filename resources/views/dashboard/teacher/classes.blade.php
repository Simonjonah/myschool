                    ...
                    @if (Auth::guard('web')->user()->promotion = 'Center Head')
                        @foreach ($view_classes as $view_classe)
                            ...
                            <tr>
                                ...
                                @endif</td>
                                <td>{{ $view_classe->centername }}</td>
                                {{-- <td><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-default">
                                Print
                                </button></td> --}}
        
                                <td>{{ $view_classe->regnumber }}</td>
                                <td>{{ $view_classe->ref_no }}</td>
                                <td><a href="{{ url('admin/editstudent/'.$view_classe->ref_no) }}"
                                    class='btn btn-info'>
                                    <i class="far fa-edit"></i>
                                </a></td>  
                                
                                
                                <th><a href="{{ url('admin/rejectstudent/'.$view_classe->ref_no) }}" class="btn btn-sm bg-teal">
                                <i class="fas fa-user"></i>
                                </a></th>
                                <th><a href="{{ url('admin/assignedteacher/'.$view_classe->ref_no) }}" class="btn btn-sm bg-teal">
                                <i class="fas fa-comments"></i>
                                </a></th><th><a href="{{ url('admin/suspendstudent/'.$view_classe->ref_no) }}" class="btn btn-sm bg-teal">
                                <i class="fas fa-comments"></i>
                                </a></th>
        
                                <th> <a href="{{ url('admin/studentsaddmit/'.$view_classe->ref_no) }}" class="btn btn-sm btn-primary">
                                <i class="fas fa-user"></i> 
                                </a></th>
                                
                                <th> <a href="{{ url('admin/studentsubjects/'.$view_classe->ref_no) }}" class="btn btn-sm btn-secondary">
                                Subjects 
                                </a></th>
                                {{-- <th><a href="{{ url('admin/studentit/'.$view_classe->ref_no) }}" class="btn btn-info"><i class="fas fa-user"></i> IT</a></th> --}}
                                <td><a href="{{ url('admin/deletestudent/'.$view_classe->ref_no) }}"
