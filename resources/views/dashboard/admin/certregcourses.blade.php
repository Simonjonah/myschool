                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach ($display_allcourses as $display_allcourse)
                        @if ($display_allcourse->registercourse['programname'] == 'Certificate in Data Processing')
                        <tr>
                          <td>{{ $display_allcourse->student['surname'] }}</td>
                          ...
                          <td><a href="{{ url('admin/view/'.$display_allcourse->id) }}"
                            class='btn btn-default'>
                            View
                         </a></td>
                            
                         <td><a href="{{ url('admin/printcoursestudent/'.$display_allcourse->id) }}"
                          class='btn btn-primary'>
                          <i class="fas fa-print"></i>
                       </a></td>
                       <td><a href="{{ url('admin/deleteprogcoursetud/'.$display_allcourse->id) }}"
