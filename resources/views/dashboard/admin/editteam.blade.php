        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ url('admin/updateteam/'.$edit_teams->id) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ $edit_teams->fname }}" name="fname" placeholder="First name">
                      </div>
                    </div>
                    @error('fname')
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ $edit_teams->lname }}" name="lname" placeholder="Last Name">
                      </div>
                    </div>
                    @error('lname')
                    <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ $edit_teams->designation }}" name="designation" placeholder="Designation">
                      </div>
                    </div>
                    @error('designation')
                    <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ $edit_teams->facebook }}" name="facebook" placeholder="facebook">
                      </div>
                    </div>
                    @error('facebook')
                    <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ $edit_teams->twitter }}" name="twitter" placeholder="twitter">
                      </div>
                    </div>
                    @error('twitter')
                    <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ $edit_teams->linkedin }}" name="linkedin" placeholder="linkedin">
                      </div>
                    </div>
                    @error('linkedin')
                    <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <td><img style="width: 50%; height: 50%;" class="profile-user-img img-fluid"
                            src="{{ URL::asset("/public/../$edit_teams->images")}}"
                            alt="User profile picture"></td>
                        <input type="file" @error('images')
                        @enderror value="" class="form-control" name="images">
                      </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      value="{{ $edit_teams->messages }}     style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $edit_teams->messages }}</textarea>
                     </div>
                      @error('messages')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
