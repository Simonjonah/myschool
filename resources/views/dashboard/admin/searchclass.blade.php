                      ...
                      <tr>
                       ...
                       <td> <div class="input-group-prepend">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li class="dropdown-item"><a href="{{ url('admin/editstudent/'.$view_schoolnametudent->ref_no1) }}">Edit</a></li>
                          <li class="dropdown-item"><a href="{{ url('admin/viewstudent/'.$view_schoolnametudent->ref_no1) }}">View</a></li>
                          <li class="dropdown-item"><a href="{{ url('admin/studentpdf/'.$view_schoolnametudent->ref_no1) }}">Print</a></li>
                          <li class="dropdown-item"><a href="{{ url('admin/teacherdelete/'.$view_schoolnametudent->ref_no1) }}">Delete</a></li>
                        </ul>
                      </div></td>
                       

                     
                      <th><a href="{{ url('admin/studentsprint') }}" class="btn btn-success"><i class="fas fa-print"></i></a></th>
                       <td><a href="{{ url('admin//'.$view_schoolnametudent->ref_no1) }}"
