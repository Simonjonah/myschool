              ...
              <div class="card-body">
                <form action="{{ route('admin.createteevent') }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                       <textarea class="textarea" name="message" class="form-control" @error('messages') is-invalid @enderror" placeholder="Place some text here"
                      value="{{ $viewsingle_blogs->messages }}     style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $viewsingle_blogs->messages }}</textarea>
                     </div>
                      @error('messages')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
