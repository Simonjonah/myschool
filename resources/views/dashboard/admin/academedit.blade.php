            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <form action="{{ url('admin/updatesession/'.$edit_sessions->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="academic_session" class="form-control" @error('academic_session')
                          
                      @enderror value="{{ $edit_sessions->academic_session }}" id="exampleInputEmail1" placeholder="Academic session ">
                    </div>
