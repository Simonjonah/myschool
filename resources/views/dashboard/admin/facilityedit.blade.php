        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ url('admin/updatefacility/'.$edit_facility->id) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ $edit_facility->title }}" name="title" placeholder="Title">
                      </div>
                    </div>
                    @error('title')
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <img style="width: 50%; height: 50%;" class="profile-user-img img-fluid"
                            src="{{ URL::asset("/public/../$edit_facility->images")}}"
                    ...
                    <div class="col-sm-6">
                      ...
                      value="{{ $edit_facility->messages }}     style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $edit_facility->messages }}</textarea>
                     </div>
                      @error('message')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
