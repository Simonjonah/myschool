          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              {{-- <div class="form-group">
                ...
                <form action="{{ url('web/createsubjectsc') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="subjectname" value="" placeholder="Subject">
                </div>

                <div class="form-group">
                    <select name="section" class="form-control" id="">
                        @foreach ($view_mysections as $view_mysection)
                          <option value="{{ $view_mysection->section }}">{{ $view_mysection->section }}</option>
