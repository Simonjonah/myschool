                  ...
                  <tbody>
                    ...
                    @if ($view_abujateacher->section == 'Secondary' || $view_abujateacher->section == 'High School' || $view_abujateacher->section == 'High Schools' )
                      <tr>
                        ...
                        <td>{{ $view_abujateacher->fname }}</td>
                        <td><img style="width: 100%; height: 60px;" src="{{ URL::asset("/public/../$view_abujateacher->images")}}" alt=""></td>
                        <td>{{ $view_abujateacher->phone }}</td>
                        {{-- <td>{{ $view_abujateacher->centername }}</td> --}}
                        <td>{{ $view_abujateacher->classname }}</td>
                        <td>{{ $view_abujateacher->section }}</td>
                        <td>{{ $view_abujateacher->term }}</td>
                        <td>{{ $view_abujateacher->email }}</td>

                       
                       
                        <td>@if ($view_abujateacher->role == 'teacher')
                          <span class="badge badge-secondary">In Progress</span>
                          @elseif ($view_abujateacher->role == 'sacked')
                          <span class="badge badge-danger">Sacked</span>
                          @elseif ($view_abujateacher->role == 'suspend')
                      ...
                      <th><a href="{{ url('admin/teachersprint') }}" class="btn btn-success"><i class="fas fa-print"></i></a></th>
                       <td><a href="{{ url('admin/teacherdelete/'.$view_abujateacher->ref_no) }}"
                        class='btn btn-danger'>
                         <i class="far fa-trash-alt"></i>
                     </a></td>
                        
                     <td>{{ $view_abujateacher->created_at->format('D d, M Y, H:i')}}</td>
