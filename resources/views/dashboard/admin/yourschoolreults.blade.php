            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 @endphp
                 <tr>
                   <td>{{ $view_schholsresult->user['schoolname'] }}</td>
                   <td>Teacher: {{ $view_schholsresult->teacher['fname'] }} <br>
                    {{ $view_schholsresult->teacher['classname'] }} 
                  </td>
                   <td>{{ $view_schholsresult->student['surname'] }}</td>
                   <td>{{ $view_schholsresult->student['fname'] }}</td>
                   <td>{{ $view_schholsresult->student['middlename'] }}</td>
                   <td>{{ $view_schholsresult->student['regnumber'] }} <small>{{ $view_schholsresult->classname }} </small></td>
                 ...
                 <td>{{ $view_schholsresult->test_3 }}</td>
         ...
         <div class="form-group">
            <label for="">Term</label>
              <select name="term" class="form-control" id="">
                @foreach ($view_schholsresults as $view_schholsresult)
                  <option value="{{ $view_schholsresult->term }}">{{ $view_schholsresult->term }}</option>
                @endforeach
              </select>
          </div>
