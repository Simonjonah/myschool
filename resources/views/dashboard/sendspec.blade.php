          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              {{-- <div class="form-group">
                ...
                <form action="{{ url('web/createclassactivityspec') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" class="form-control" name="student_id" value="{{ $viewparent_sendpecti->id }}" placeholder=":">
