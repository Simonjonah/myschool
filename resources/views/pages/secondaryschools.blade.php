	...
	<section class="blog-Press-section">
		<div class="auto-container">
			...
			<div class="row clearfix">
                ...
                @if ($press_releases->status == 'admitted')
                    <!-- News Block Three -->
				<div class="news-block-three col-lg-3 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							...
							<h4><a href="{{ url('viewschoolsingle/'.$press_releases->slug) }}">{{ $press_releases->schoolname }}</a></h4>
							{{-- <span><a href="{{ url('viewschoolsingle/'.$press_releases->slug) }}">messages</a></span> --}}

							<a class="btn btn-success" href="{{ url('viewschoolsingle/'.$press_releases->slug) }}">Continue Reading <span class="fa fa-angle-double-right"></span></a>
						</div>
					</div>
				</div>
                @else
