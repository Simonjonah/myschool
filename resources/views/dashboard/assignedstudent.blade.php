  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Assigned Student</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Update Class and term {{ $assign_teachers->fname }} </h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ url('web/assignstudentclass/'.$assign_teachers->ref_no) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
            ...
            <div class="card-body">
                  ...
                  <div class="form-group">
                   ...
                   <input type="hidden" value="{{ $assign_teachers->ref_no }}" name="ref_no" class="form-control" placeholder="First Name">
                    ...
                    <input type="hidden" value="{{ $assign_teachers->centername }}" name="centername" class="form-control" placeholder="First Name"> 
                    <input type="hidden" value="{{ $assign_teachers->term }}" name="term" class="form-control" placeholder="term">  --}}
