              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @if (Auth::guard('web')->user()->promotion = 'Primary Head')
                    ...
                    @if ($view_primarystudent->section == Auth::guard('web')->user()->section && $view_primarystudent->status == null)
                      <tr>
                        ...
                        <td>{{ $view_primarystudent->section }}
                            <small style="color: red">{{ $view_primarystudent->section }}</small>
                        </td>
  
                        <td><img style="width: 100%; height: 60px;" src="{{ URL::asset("/public/../$view_primarystudent->images")}}" alt=""></td>
                        <td><a href="{{ url('admin/viewstudents/'.$view_primarystudent->ref_no) }}"
                      ...
                      <td>{{ $view_primarystudent->ref_no }}</td>
                        <td><a href="{{ url('admin/editstudent/'.$view_primarystudent->ref_no) }}"
                          class='btn btn-info'>
                          <i class="far fa-edit"></i>
                      </a></td>  
                      
                        
                      <th><a href="{{ url('admin/rejectstudent/'.$view_primarystudent->ref_no) }}" class="btn btn-sm bg-teal">
                        <i class="fas fa-user"></i>
                      </a></th>
                      <th><a href="{{ url('admin/assignedteacher/'.$view_primarystudent->ref_no) }}" class="btn btn-sm bg-teal">
                        <i class="fas fa-comments"></i>
                      </a></th><th><a href="{{ url('admin/suspendstudent/'.$view_primarystudent->ref_no) }}" class="btn btn-sm bg-teal">
                        <i class="fas fa-comments"></i>
                      </a></th>
  
                      <th> <a href="{{ url('admin/studentsaddmit/'.$view_primarystudent->ref_no) }}" class="btn btn-sm btn-primary">
                        <i class="fas fa-user"></i> 
                      </a></th>
                      <th> <a href="{{ url('admin/studentsubjects/'.$view_primarystudent->ref_no) }}" class="btn btn-sm btn-primary">
                        <i class="fas fa-user"></i> 
                      </a></th>
                    
                      {{-- <th><a href="{{ url('admin/studentit/'.$view_primarystudent->ref_no) }}" class="btn btn-info"><i class="fas fa-user"></i> IT</a></th> --}}
                      <td><a href="{{ url('admin/deletestudent/'.$view_primarystudent->ref_no) }}"
