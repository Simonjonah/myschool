@include('dashboard.header')
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  {{-- @if (Auth::guard('web')->user()->section = 'Pre-School') --}}
                    ...
                    @if ($view_highstudent->term == Auth::guard('web')->user()->term && $view_highstudent->status == null)
                      <tr>
                        ...
                        {{-- <td><a href="{{ url('admin/viewstudents/'.$view_highstudent->ref_no1) }}"
                      ...
                      <th> <a href="{{ url('web/studentsubjectsbyheads/'.$view_highstudent->ref_no1) }}" class="btn btn-sm btn-primary">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="https://Goldenschoolsacademy.com">Goldenschoolsacademy.com</a>.</strong> All rights
    reserved.
  </footer>
