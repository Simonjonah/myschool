                  ...
                  <tbody>
                    ...
                    @foreach ($view_myresults as $view_myresult)
                      ...
                      <tr>
                        ...
                        <td>{{ $view_myresult->fname }} <br> <small> Teacher: <a href="{{ url('web/viewtteachersc/'.$view_myresult->teacher['ref_no']) }}">{{ $view_myresult->teacher['fname'] }} {{ $view_myresult->teacher['surname'] }} {{ $view_myresult->teacher['classname'] }} {{ $view_myresult->teacher['term'] }}</a> 
