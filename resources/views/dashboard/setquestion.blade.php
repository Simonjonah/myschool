          ...
          <div class="card-body">
            <div class="row">
              <div class="col-12 col-sm-6">
                ...
                <div class="col-12">
                  <form action="{{ url('web/createquestion') }}" method="post">
                    @csrf
                ...
                <div class="form-group">
                  <p>Question</p>
                  <input type="text" class="form-control" value="" name="question"  placeholder="Question">
              </div>

                <div class="form-group">
                  <p>Subject</p>
                  <input type="text" name="subjectname" class="form-control" value="{{ $view_subject->subject['subjectname'] }}" name="subjectname" id="" placeholder="Subject">
                </div>

                <div class="form-group">
                  <p>Option1</p>
                  <input type="text" class="form-control" value="" name="option1" id="" placeholder="Option1">
                </div>
             ...
             <div class="col-12 col-sm-6">
                <div class="form-group">
                  <p>Option2</p>
                  <input type="text" class="form-control" value="" name="option2" id="" placeholder="Option2">
                </div>

                <div class="form-group">
                  <p>Option3</p>
                  <input type="text" class="form-control" value="" name="option3" id="" placeholder="Option3">
                </div>


              <div class="form-group">
                  <p>Answer</p>
                  <input type="text" class="form-control" value="" name="is_correct" id="" placeholder="Answer">
                </div>

                <div class="form-group">
                  <p>Centername</p>
                  <input type="text" class="form-control" value="{{ Auth::guard('web')->user()->centername }}" name="centername" id="" placeholder="centername">
                </div>
