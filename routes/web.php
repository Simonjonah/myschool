...
Route::get('/primaryschools/{lga}', function ($lga) {
    $primary_schools = State::where('lga', $lga)->first();
    $primary_schools = User::where('lga', $lga)->where('status', 'admitted')->where('schooltype', 'Primary')
    ->latest()->get();
    return view('pages.primaryschools', compact('primary_schools'));
});

Route::get('/secondaryschools/{lga}', function ($lga) {
    $secondary_schools = State::where('lga', $lga)->first();
    $secondary_schools = User::where('lga', $lga)->where('status', 'admitted')->where('schooltype', 'Secondary')
    ->latest()->get();
...
Route::get('/lgaschools', function () {
    $view_lgas = State::orderBy('lga')->get();
...
>>>>>>> 24956a9587870d2e17edb15dd277aeb5954f2c0e
...
<<<<<<< HEAD
        Route::get('addlga', [StateController::class, 'addlga'])->name('addlga');
        Route::post('createlga', [StateController::class, 'createlga'])->name('createlga');
        ...
        Route::get('viewlga', [StateController::class, 'viewlga'])->name('viewlga');
        Route::get('editlga/{id}', [StateController::class, 'editlga'])->name('editlga');
        Route::get('deletelga/{id}', [StateController::class, 'deletelga'])->name('deletelga');
        Route::put('updatelga/{id}', [StateController::class, 'updatelga'])->name('updatelga');
        Route::get('viewperlgaschools', [StateController::class, 'viewperlgaschools'])->name('viewperlgaschools');
        Route::get('viewsinglelgasschool/{lga}', [StateController::class, 'viewsinglelgasschool'])->name('viewsinglelgasschool');
        Route::get('viewprimariesschools/{lga}', [StateController::class, 'viewprimariesschools'])->name('viewprimariesschools');
        Route::get('viewsecondariesschools/{lga}', [StateController::class, 'viewsecondariesschools'])->name('viewsecondariesschools');
