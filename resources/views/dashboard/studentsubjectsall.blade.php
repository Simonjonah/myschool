...
{{-- 
               ...
               <div class="col-lg-8 col-md-3 col-sm-4 invoice-col">
                ...
                <!-- /.col -->
                <div class="col-lg-2 col-md-3 col-sm-4 invoice-col">
                    <img style="width: 70%; height: 100px;" src="{{ URL::asset("/public/../$view_studentsubjects->images")}}" alt="">
                </div>
                <!-- /.col -->
              </div>
              <!-- /.row -->
                ...
                <div class="col-12 table-responsive">
                  ...
                  <form action="" method="post">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @foreach ($view_subjects as $view_subject)
                              @if ($view_subject->section == 'Secondary')
                              <tr>
                                <td>{{ $view_subject->subjectname }}</td>
                                <td><input type="number" class="form-control" name="test_1" placeholder="Test 1"></td>
                                <td><input type="number" class="form-control" name="test_2" placeholder="Test 2"></td>
              ...
              <div class="row no-print">
                <div class="col-12">
                  ...
                  <button type="button" class="btn btn-success float-right"><i class="far fa-credit-card"></i> View
