                  ...
                  <tbody>
                    ...
                    @if ($view_uyoteacher->section == 'Prmary' || $view_uyoteacher->section == 'Elementary' || $view_uyoteacher->section == 'Creche' || $view_uyoteacher->section == 'Pre-School' || $view_uyoteacher->section == 'Pre - Schools' || $view_uyoteacher->section == 'Pre-school' || $view_uyoteacher->section == 'Nursery')
                      ...
                      <tr>
                        ...
                        <td>@if ($view_uyoteacher->role == 'teacher')
                          <span class="badge badge-secondary">In Progress</span>
                          @elseif ($view_uyoteacher->role == 'sacked')
                          <span class="badge badge-danger">Sacked</span>
                          @elseif ($view_uyoteacher->role == 'suspend')
                       ...
                       <td> <div class="input-group-prepend">
                        ...
                        <ul class="dropdown-menu">
                          <li class="dropdown-item"><a href="{{ url('admin/viewsingleteacher/'.$view_uyoteacher->ref_no) }}">View</a></li>
                          <li class="dropdown-item"><a href="{{ url('admin/editteacher/'.$view_uyoteacher->ref_no) }}">Edit</a></li>
                          <li class="dropdown-item"><a href="{{ url('admin/teacherapprove/'.$view_uyoteacher->ref_no) }}">Approved</a></li>
                          <li class="dropdown-item"><a href="{{ url('admin/teachersuspend/'.$view_uyoteacher->ref_no) }}">Suspend</a></li>
                          <li class="dropdown-item"><a href="{{ url('admin/teachersacked/'.$view_uyoteacher->ref_no) }}">Sacked</a></li>
                          <li class="dropdown-item"><a href="{{ url('admin/teacherquery/'.$view_uyoteacher->ref_no) }}">Query</a></li>
                        </ul>
                      </div></td>
                       
                     
                      <th><a href="{{ url('admin/teachersprint') }}" class="btn btn-success"><i class="fas fa-print"></i></a></th>
                       <td><a href="{{ url('admin/teacherdelete/'.$view_uyoteacher->ref_no) }}"
                        class='btn btn-danger'>
                         <i class="far fa-trash-alt"></i>
                     </a></td>
                        
                     <td>{{ $view_uyoteacher->created_at->format('D d, M Y, H:i')}}</td>
