          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              {{-- <div class="form-group">
                ...
                <form action="{{ url('web/updateclassessc/'.$edit_terms->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="term" value="{{ $edit_terms->term }}" placeholder="Term">
                </div>
