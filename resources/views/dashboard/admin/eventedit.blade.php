        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ url('admin/updateevent/'.$edit_events->ref_no) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ $edit_events->title }}" name="title" placeholder="Title">
                      </div>
                    </div>
                    @error('title')
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <img style="width: 50%; height: 50%;" class="profile-user-img img-fluid"
                            src="{{ URL::asset("/public/../$edit_events->images")}}"
                    ...
                    <div class="col-sm-6">
                      ...
                      value="{{ $edit_events->message }}     style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $edit_events->message }}</textarea>
                     </div>
                      @error('message')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
