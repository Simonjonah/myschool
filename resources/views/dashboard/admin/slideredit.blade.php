        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ url('admin/updateslider/'.$edit_sliders->id) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          @enderror value="{{ $edit_sliders->centername }}" name="centername" placeholder="centername">
                        </div>
                      </div>
                      @error('centername')
                      <span class="text-danger">{{ $message }}</span>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          @enderror value="{{ $edit_sliders->facts }}" name="facts" placeholder="facts">
                        </div>
                      </div>
                      @error('facts')
                      <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label> Image</label>
                        <img style="width: 40px; height: 40px;" src="{{ URL::asset("/public/../$edit_sliders->images")}}" alt="">
