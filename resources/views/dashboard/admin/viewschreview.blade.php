                  ...
                  <tbody>
                    ...
                    @foreach ($school_reviews as $school_review)
                      ...
                      <tr>
                        ...
                        <td>{{ $school_review->ref_no1 }}</td>
                        <td>{{ $school_review->plans }}</td>
                        <td><img style="width: 100%; height: 60px;" src="{{ URL::asset("/public/../$school_review->logo")}}" alt=""></td>
                     ...
                     <td>{{ $school_review->created_at->format('D d, M Y, H:i')}}</td>
