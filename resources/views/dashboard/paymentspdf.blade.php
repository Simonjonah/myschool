    ...
    <div class="row">
      <div class="col-12 table-responsive">
        <table class="table table-striped">
          ...
          <tbody>
          <tr>
            <td>{{ $print_payments->student['fname']}}</td>
            <td>{{ $print_payments->student['middlename'] }}</td>
            <td>{{ $print_payments->student['surname'] }}</td>

            <td>{{ $print_payments->student['regnumber'] }}</td>
            <td>{{ $print_payments->student['programname'] }}</td>
      ...
      <div class="col-6">
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tr>
              <th>Semester</th>
              <td>{{ $print_payments->semester}}</td>
            </tr>
            
            <tr>
              <th>Level</th>
              <td>{{ $print_payments->level}}</td>
            </tr>
          </table>
        </div>
      </div>
