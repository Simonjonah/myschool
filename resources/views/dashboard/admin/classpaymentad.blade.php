                    ...
                    @foreach ($view_classes as $view_classe)
                      ...
                      <tr>
                        ...
                        <td>{{ $view_classe->ref_no }}</td>
                         ...
                         <td><a href="{{ url('admin/viewsinglepaymentsad/'.$view_classe->ref_no) }}"
                          class='btn btn-info'>
                           <i class="far fa-eye"></i>
                       </a></td>
                       <td>@if ($view_classe->processor_response == null)
                        <span class="badge badge-secondary"> Pending</span>
                       @elseif($view_classe->processor_response == 'Success')
                       <span class="badge badge-info"> Success</span>
                       @elseif($view_classe->processor_response == 'successful')
                       <span class="badge badge-success"> successful</span>
                      
                       @elseif($view_classe->processor_response == 'confirm')
                       
                       <span class="badge badge-success">Confirm</span>
                       @endif</td>
                       
                       <th><a href="{{ url('admin/confirmpayment/'.$view_classe->id) }}" class="btn btn-sm bg-teal">
                        <i class="fas fa-user"></i>
                      </a></th>

                      <th><a href="printpdf" class="btn btn-success"><i class="fas fa-print"></i></a></th>
                       <td><a href="{{ url('admin/deletepayment/'.$view_classe->slug) }}"
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a href="">GOLDEN DESTINY ACADEMY</a>.</strong> All rights
    reserved.
  </footer>
