        ...
        <div class="col-md-12">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">Add Class Alms if Any</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              {{-- <div class="form-group">
                ...
                <form action="{{ url('web/createalms') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  {{-- <input type="text" class="form-control" name="" value="" placeholder="Class alms"> --}}
                </div>

                <div class="col-sm-6">
                  <div class="form-group">
                    <label>Class Alms</label>
                  <input type="text" name="alms" @error('alms')
                  @enderror  value="" class="form-control" placeholder="Class Alms">
