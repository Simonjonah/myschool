        ...
        <div class="col-md-12">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">Add Pscomotive/Cognitive Domain</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              {{-- <div class="form-group">
                ...
                <form action="{{ url('web/createsdomains') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="cogname" value="" placeholder="Add Domins">
                </div>
