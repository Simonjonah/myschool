  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Add Term</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <form action="{{ url('admin/updatetermad/'.$edit_terms->id) }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" value="{{ $edit_terms->term }}" name="term" class="form-control" @error('term')
                          
                      @enderror  id="exampleInputEmail1" placeholder="Term">
                    </div>
                    @error('term')
