            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <form action="{{ route('admin.createtermad') }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="term" class="form-control" @error('term')
                          
                      @enderror value="{{ old('term') }}" id="exampleInputEmail1" placeholder="Term">
                    </div>
                    @error('term')
