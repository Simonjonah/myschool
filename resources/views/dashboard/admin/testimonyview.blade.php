                ...
                <form action="{{ route('admin.createtestimony') }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      value="{{ $view_singletestimonies->message }}     style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $view_singletestimonies->message }}</textarea>
                     </div>
                      @error('message')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
