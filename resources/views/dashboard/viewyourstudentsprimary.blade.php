                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach ($view_primarypupils as $view_primarypupil)
                      {{-- @if ($view_primarypupil->section == Auth::guard('web')->user()->section &&  $view_primarypupil->term == Auth::guard('web')->user()->term && $view_primarypupil->classname == Auth::guard('web')->user()->classname && $view_primarypupil->role == Auth::guard('web')->user()->role = null) --}}
                        <tr>
                          <td>{{ $view_primarypupil->fname }}</td>
                          <td>{{ $view_primarypupil->middlename }}</td>
                          <td>{{ $view_primarypupil->surname }}</td>
                          <td> {{ $view_primarypupil->section }}</td>
                          <td> {{ $view_primarypupil->classname }}</td>
                          <td> {{ $view_primarypupil->term }}</td>
