          ...
          <div class="col-md-12">
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Add Study Center</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ route('admin.createstudycenter') }}" method="post" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label> Name</label>
                      <input type="text" class="form-control" @error('section')
                      @enderror value="{{ old('section') }}" name="section" placeholder="section">
                    </div>
                  </div>
                @error('section')
                <span class="text-danger">{{ $message }}</span>
                ...
                {{-- <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    @enderror value="{{ old('name') }}" name="name" placeholder="name">
                  </div>
                </div>
              @error('name')
              <span class="text-danger">{{ $message }}</span>
