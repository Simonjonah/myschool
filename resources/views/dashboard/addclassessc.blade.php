            ...
            <div class="card-body">
              {{-- <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" class="form-control" name="slug" value="{{ Auth::guard('web')->user()->slug }}" placeholder=":">
                  ...
                  <input type="text" class="form-control" name="classname" value="" placeholder="Class name">
                </div>

                <div class="form-group">
                    <select name="section" class="form-control" id="">
                      @foreach ($view_classes_scs as $view_classes_sc)
                      <option value="{{ $view_classes_sc->section }}">{{ $view_classes_sc->section }}</option>
                      @endforeach
