...
<div class="wrapper">
          ...
          <div class="col-md-12">
            <div class="card card-outline card-info">
              ...
              <div class="card-body pad">
                <form action="{{ url('admin/addquerytoteacher/'.$query_singteachers->ref_no1) }}" method="post" enctype="multipart/form-data">
                  @csrf
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2024 <a href="https://golderndayschools.com">golderndayschools.com</a>.</strong> All rights
    reserved.
  </footer>
